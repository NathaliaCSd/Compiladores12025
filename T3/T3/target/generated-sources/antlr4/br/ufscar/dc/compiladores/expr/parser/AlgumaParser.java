...
public class AlgumaParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, ALGORITMO=3, DECLARE=4, FIM_ALGORITMO=5, LEIA=6, ESCREVA=7, 
		LITERAL=8, INTEIRO=9, REAL=10, LOGICO=11, E=12, OU=13, NAO=14, SE=15, 
		ENTAO=16, SENAO=17, FIM_SE=18, CASO=19, SEJA=20, FIM_CASO=21, PARA=22, 
		ATE=23, FACA=24, FIM_PARA=25, ENQUANTO=26, FIM_ENQUANTO=27, REGISTRO=28, 
		FIM_REGISTRO=29, TIPO=30, PROCEDIMENTO=31, FIM_PROCEDIMENTO=32, VAR=33, 
		FUNCAO=34, FIM_FUNCAO=35, RETORNE=36, CONSTANTE=37, FALSO=38, VERDADEIRO=39, 
		DOIS_PONTOS=40, ABRE_PAR=41, FECHA_PAR=42, VIRGULA=43, INTERVALO=44, ATRIBUICAO=45, 
		PONTEIRO=46, REFERENCIA=47, PONTO=48, ABRE_COLCH=49, FECHA_COLCH=50, MAIS=51, 
		MENOS=52, MULT=53, DIV=54, MOD=55, MENOR=56, MAIOR=57, MENOR_IGUAL=58, 
		MAIOR_IGUAL=59, IGUAL=60, DIFERENTE=61, NUM_INT=62, NUM_REAL=63, CADEIA_INACABADO=64, 
		CADEIA=65, IDENT=66, COMENTARIO_INACABADO=67, COMENTARIO=68, WS=69, ERROR=70;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'REGISTRO'", "'NAO'", "'algoritmo'", "'declare'", "'fim_algoritmo'", 
			"'leia'", "'escreva'", "'literal'", "'inteiro'", "'real'", "'logico'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "ALGORITMO", "DECLARE", "FIM_ALGORITMO", "LEIA", "ESCREVA", 
	...
	public final ProgramaContext programa() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 157840048144L) != 0) {
				{
				{
				setState(98);
				declaracoes();
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(181);
			_la = _input.LA(1);
			if ( !((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & 184549379L) != 0) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case PROCEDIMENTO:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 138512695312L) != 0) {
					{
					{
					setState(190);
					declaracao_local();
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la - 6)) & ~0x3f) == 0 && ((1L << (_la - 6)) & 1152922605193601539L) != 0) {
					{
					{
					setState(196);
					cmd();
	...
	public static class Parcela_nao_unarioContext extends ParserRuleContext {
		...
		public Token pn2;
		public TerminalNode REFERENCIA() { return getToken(AlgumaParser.REFERENCIA, 0); }
		public IdentificadorContext identificador() {
			return getRuleContext(IdentificadorContext.class,0);
		}
		public TerminalNode CADEIA() { return getToken(AlgumaParser.CADEIA, 0); }
