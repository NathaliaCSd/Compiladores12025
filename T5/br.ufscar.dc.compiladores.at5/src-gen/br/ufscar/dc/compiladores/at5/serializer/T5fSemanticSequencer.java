 ...
 */
package br.ufscar.dc.compiladores.at5.serializer;
...
public class T5fSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == T5fPackage.eINSTANCE)
	...
	protected void sequence_ComandoAtribuicao(ISerializationContext context, ComandoAtribuicao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.COMANDO_ATRIBUICAO__TARGET) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.COMANDO_ATRIBUICAO__TARGET));
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.COMANDO_ATRIBUICAO__VALOR) == ValueTransient.YES)
	...
	protected void sequence_ComandoRetorne(ISerializationContext context, ComandoRetorne semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.COMANDO_RETORNE__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.COMANDO_RETORNE__EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Dimensao(ISerializationContext context, Dimensao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.DIMENSAO__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.DIMENSAO__EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OutroFatorAritmetico(ISerializationContext context, OutroFatorAritmetico semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.OUTRO_FATOR_ARITMETICO__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.OUTRO_FATOR_ARITMETICO__OP));
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.OUTRO_FATOR_ARITMETICO__FATOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.OUTRO_FATOR_ARITMETICO__FATOR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OutroTermoAritmetico(ISerializationContext context, OutroTermoAritmetico semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.OUTRO_TERMO_ARITMETICO__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.OUTRO_TERMO_ARITMETICO__OP));
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.OUTRO_TERMO_ARITMETICO__TERMO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.OUTRO_TERMO_ARITMETICO__TERMO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_Variavel(ISerializationContext context, Variavel semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.VARIAVEL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.VARIAVEL__NAME));
			if (transientValues.isValueTransient(semanticObject, T5fPackage.Literals.VARIAVEL__TIPO_VAR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5fPackage.Literals.VARIAVEL__TIPO_VAR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVariavelAccess().getNameIdentificadorParserRuleCall_0_0(), semanticObject.getName());
