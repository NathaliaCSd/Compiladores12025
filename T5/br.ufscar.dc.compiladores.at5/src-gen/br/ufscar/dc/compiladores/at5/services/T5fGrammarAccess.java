 ...
 */
package br.ufscar.dc.compiladores.at5.services;
...
@Singleton
public class T5fGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class ProgramaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Programa");
	...
	public class DeclaracaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Declaracao");
	...
	public class DeclaracaoLocalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.DeclaracaoLocal");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DeclaracaoGlobalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.DeclaracaoGlobal");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class VariavelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Variavel");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNameAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cNameIdentificadorParserRuleCall_0_0 = (RuleCall)cNameAssignment_0.eContents().get(0);
		...
		//Variavel:
		//    name=Identificador ':' tipoVar=Tipo
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//Identificador
		public RuleCall getNameIdentificadorParserRuleCall_0_0() { return cNameIdentificadorParserRuleCall_0_0; }
	...
	public class IdentificadorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Identificador");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNameAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class DimensaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Dimensao");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TipoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Tipo");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class RegistroElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Registro");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cRegistroAction_0 = (Action)cGroup.eContents().get(0);
		...
		private final RuleCall cCamposVariavelParserRuleCall_2_0 = (RuleCall)cCamposAssignment_2.eContents().get(0);
		private final Keyword cFim_registroKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//{Registro}
		public Action getRegistroAction_0() { return cRegistroAction_0; }
		...
		//Variavel
		public RuleCall getCamposVariavelParserRuleCall_2_0() { return cCamposVariavelParserRuleCall_2_0; }
		
		//'fim_registro'
		public Keyword getFim_registroKeyword_3() { return cFim_registroKeyword_3; }
	}
	public class TipoEstendidoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.TipoEstendido");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TipoBasicoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.TipoBasico");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ValorConstanteElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ValorConstante");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ParametrosElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Parametros");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ParametroElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Parametro");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CorpoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Corpo");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cCorpoAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cLocaisAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cLocaisDeclaracaoLocalParserRuleCall_1_0 = (RuleCall)cLocaisAssignment_1.eContents().get(0);
		...
		//{Corpo}
		public Action getCorpoAction_0() { return cCorpoAction_0; }
		
		//(locais+=DeclaracaoLocal)*
		public Assignment getLocaisAssignment_1() { return cLocaisAssignment_1; }
		
		//DeclaracaoLocal
		public RuleCall getLocaisDeclaracaoLocalParserRuleCall_1_0() { return cLocaisDeclaracaoLocalParserRuleCall_1_0; }
	...
	public class ComandoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Comando");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ComandoLeiaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoLeia");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cAlvoIdentificadorCrossReference_3_0 = (CrossReference)cAlvoAssignment_3.eContents().get(0);
		private final RuleCall cAlvoIdentificadorIDTerminalRuleCall_3_0_1 = (RuleCall)cAlvoIdentificadorCrossReference_3_0.eContents().get(1);
		...
		private final CrossReference cAlvoIdentificadorCrossReference_4_2_0 = (CrossReference)cAlvoAssignment_4_2.eContents().get(0);
		private final RuleCall cAlvoIdentificadorIDTerminalRuleCall_4_2_0_1 = (RuleCall)cAlvoIdentificadorCrossReference_4_2_0.eContents().get(1);
		private final Keyword cRightParenthesisKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		//ComandoLeia:
		//'leia' '(' ('^')? alvo+=[Identificador|ID] (',' ('^')? alvo+=[Identificador|ID])* ')'
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//alvo+=[Identificador|ID]
		public Assignment getAlvoAssignment_3() { return cAlvoAssignment_3; }
		
		//[Identificador|ID]
		public CrossReference getAlvoIdentificadorCrossReference_3_0() { return cAlvoIdentificadorCrossReference_3_0; }
		
		//ID
		public RuleCall getAlvoIdentificadorIDTerminalRuleCall_3_0_1() { return cAlvoIdentificadorIDTerminalRuleCall_3_0_1; }
		...
		//[Identificador|ID]
		public CrossReference getAlvoIdentificadorCrossReference_4_2_0() { return cAlvoIdentificadorCrossReference_4_2_0; }
		
		//ID
		public RuleCall getAlvoIdentificadorIDTerminalRuleCall_4_2_0_1() { return cAlvoIdentificadorIDTerminalRuleCall_4_2_0_1; }
		
		//')'
		public Keyword getRightParenthesisKeyword_5() { return cRightParenthesisKeyword_5; }
	}
	public class ComandoEscrevaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoEscreva");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComandoSeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoSe");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComandoCasoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoCaso");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComandoParaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoPara");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComandoEnquantoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoEnquanto");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComandoFacaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoFaca");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComandoAtribuicaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoAtribuicao");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cAtribuaKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cTargetAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final CrossReference cTargetIdentificadorCrossReference_1_0 = (CrossReference)cTargetAssignment_1.eContents().get(0);
		private final RuleCall cTargetIdentificadorIDTerminalRuleCall_1_0_1 = (RuleCall)cTargetIdentificadorCrossReference_1_0.eContents().get(1);
		private final Keyword cLessThanSignHyphenMinusKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//ComandoAtribuicao:
		//     'atribua' target=[Identificador|ID] '<-' valor=Expressao
		//   ;
		@Override public ParserRule getRule() { return rule; }
		...
		//'atribua'
		public Keyword getAtribuaKeyword_0() { return cAtribuaKeyword_0; }
		
		//target=[Identificador|ID]
		public Assignment getTargetAssignment_1() { return cTargetAssignment_1; }
		
		//[Identificador|ID]
		public CrossReference getTargetIdentificadorCrossReference_1_0() { return cTargetIdentificadorCrossReference_1_0; }
		
		//ID
		public RuleCall getTargetIdentificadorIDTerminalRuleCall_1_0_1() { return cTargetIdentificadorIDTerminalRuleCall_1_0_1; }
	...
	public class ComandoChamadaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoChamada");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cChameKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		private final RuleCall cArgsExpressaoParserRuleCall_3_0_0 = (RuleCall)cArgsAssignment_3_0.eContents().get(0);
		private final Group cGroup_3_1 = (Group)cGroup_3.eContents().get(1);
		private final Keyword cCommaKeyword_3_1_0 = (Keyword)cGroup_3_1.eContents().get(0);
		private final Assignment cArgsAssignment_3_1_1 = (Assignment)cGroup_3_1.eContents().get(1);
		private final RuleCall cArgsExpressaoParserRuleCall_3_1_1_0 = (RuleCall)cArgsAssignment_3_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//'chame'
		public Keyword getChameKeyword_0() { return cChameKeyword_0; }
		...
		//Expressao
		public RuleCall getArgsExpressaoParserRuleCall_3_0_0() { return cArgsExpressaoParserRuleCall_3_0_0; }
		...
		//Expressao
		public RuleCall getArgsExpressaoParserRuleCall_3_1_1_0() { return cArgsExpressaoParserRuleCall_3_1_1_0; }
		
		//')'
		public Keyword getRightParenthesisKeyword_4() { return cRightParenthesisKeyword_4; }
	}
	public class ComandoRetorneElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ComandoRetorne");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SelecaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Selecao");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ItemSelecaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ItemSelecao");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumeroIntervaloElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.NumeroIntervalo");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OpUnarioElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OpUnario");
	...
	public class ExpressaoAritmeticaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ExpressaoAritmetica");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OutroTermoAritmeticoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OutroTermoAritmetico");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TermoAritmeticoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.TermoAritmetico");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OutroFatorAritmeticoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OutroFatorAritmetico");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cOpAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class FatorAritmeticoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.FatorAritmetico");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		...
		private final CrossReference cRefIdentificadorCrossReference_0_1_0 = (CrossReference)cRefAssignment_0_1.eContents().get(0);
		private final RuleCall cRefIdentificadorIDTerminalRuleCall_0_1_0_1 = (RuleCall)cRefIdentificadorCrossReference_0_1_0.eContents().get(1);
		...
		//[Identificador|ID]
		public CrossReference getRefIdentificadorCrossReference_0_1_0() { return cRefIdentificadorCrossReference_0_1_0; }
		
		//ID
		public RuleCall getRefIdentificadorIDTerminalRuleCall_0_1_0_1() { return cRefIdentificadorIDTerminalRuleCall_0_1_0_1; }
	...
	public class ExpressaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.Expressao");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TermoLogicoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.TermoLogico");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNaoAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cNaoNaoKeyword_0_0 = (Keyword)cNaoAssignment_0.eContents().get(0);
		...
		//'nao'
		public Keyword getNaoNaoKeyword_0_0() { return cNaoNaoKeyword_0_0; }
	...
	public class ExpressaoRelacionalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ExpressaoRelacional");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OpArit1Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OpArit1");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OpArit2Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OpArit2");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OpRelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OpRel");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OpBoolElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.OpBool");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public T5fGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tREAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.REAL");
		this.tID = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ID");
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.INT");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.STRING");
		this.tML_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.ML_COMMENT");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.SL_COMMENT");
		this.tWS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.at5.T5f.WS");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("br.ufscar.dc.compiladores.at5.T5f".equals(grammar.getName())) {
				return grammar;
			}
