 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.ComandoAtribuicaoImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.ComandoAtribuicaoImpl#getValor <em>Valor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComandoAtribuicaoImpl extends ComandoImpl implements ComandoAtribuicao
{
  ...
  {
    return T5fPackage.Literals.COMANDO_ATRIBUICAO;
  }
    ...
    if (target != null && target.eIsProxy())
    {
      ...
      if (target != oldTarget)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, T5fPackage.COMANDO_ATRIBUICAO__TARGET, oldTarget, target));
      }
    }
    return target;
  }
  ...
  public NotificationChain basicSetValor(Expressao newValor, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, T5fPackage.COMANDO_ATRIBUICAO__VALOR, oldValor, newValor);
  ...
  public void setValor(Expressao newValor)
  {
    if (newValor != valor)
    {
      ...
      if (valor != null)
        msgs = ((InternalEObject)valor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - T5fPackage.COMANDO_ATRIBUICAO__VALOR, null, msgs);
      if (newValor != null)
        msgs = ((InternalEObject)newValor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - T5fPackage.COMANDO_ATRIBUICAO__VALOR, null, msgs);
      msgs = basicSetValor(newValor, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5fPackage.COMANDO_ATRIBUICAO__VALOR, newValor, newValor));
  }
