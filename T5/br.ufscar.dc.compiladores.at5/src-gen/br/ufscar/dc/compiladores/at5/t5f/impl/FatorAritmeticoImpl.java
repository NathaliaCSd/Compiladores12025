 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.FatorAritmeticoImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.FatorAritmeticoImpl#getNumero <em>Numero</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.FatorAritmeticoImpl#getReal <em>Real</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.FatorAritmeticoImpl#getExp <em>Exp</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.FatorAritmeticoImpl#getStr <em>Str</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FatorAritmeticoImpl extends MinimalEObjectImpl.Container implements FatorAritmetico
{
  ...
  {
    return T5fPackage.Literals.FATOR_ARITMETICO;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, T5fPackage.FATOR_ARITMETICO__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setNumero(int newNumero)
  {
    ...
    numero = newNumero;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5fPackage.FATOR_ARITMETICO__NUMERO, oldNumero, numero));
  }
  ...
  public void setReal(String newReal)
  {
    ...
    real = newReal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5fPackage.FATOR_ARITMETICO__REAL, oldReal, real));
  }
  ...
  public NotificationChain basicSetExp(ExpressaoAritmetica newExp, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, T5fPackage.FATOR_ARITMETICO__EXP, oldExp, newExp);
  ...
  public void setExp(ExpressaoAritmetica newExp)
  {
    if (newExp != exp)
    {
      ...
      if (exp != null)
        msgs = ((InternalEObject)exp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - T5fPackage.FATOR_ARITMETICO__EXP, null, msgs);
      if (newExp != null)
        msgs = ((InternalEObject)newExp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - T5fPackage.FATOR_ARITMETICO__EXP, null, msgs);
      msgs = basicSetExp(newExp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5fPackage.FATOR_ARITMETICO__EXP, newExp, newExp));
  }
  ...
  public void setStr(String newStr)
  {
    ...
    str = newStr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5fPackage.FATOR_ARITMETICO__STR, oldStr, str));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case T5fPackage.FATOR_ARITMETICO__EXP:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case T5fPackage.FATOR_ARITMETICO__NUMERO:
        return getNumero();
      case T5fPackage.FATOR_ARITMETICO__REAL:
        return getReal();
      case T5fPackage.FATOR_ARITMETICO__EXP:
        return getExp();
      case T5fPackage.FATOR_ARITMETICO__STR:
        return getStr();
    }
