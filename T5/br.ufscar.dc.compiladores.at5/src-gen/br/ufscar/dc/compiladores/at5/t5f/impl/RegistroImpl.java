 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.RegistroImpl#getCampos <em>Campos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegistroImpl extends MinimalEObjectImpl.Container implements Registro
{
  ...
  {
    return T5fPackage.Literals.REGISTRO;
  }
  ...
  public EList<Variavel> getCampos()
  {
    if (campos == null)
    {
      campos = new EObjectContainmentEList<Variavel>(Variavel.class, this, T5fPackage.REGISTRO__CAMPOS);
    }
    return campos;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case T5fPackage.REGISTRO__CAMPOS:
