 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.TermoAritmeticoImpl#getFatores <em>Fatores</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.at5.t5f.impl.TermoAritmeticoImpl#getOutros <em>Outros</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TermoAritmeticoImpl extends MinimalEObjectImpl.Container implements TermoAritmetico
{
  ...
  {
    return T5fPackage.Literals.TERMO_ARITMETICO;
  }
  ...
  public EList<FatorAritmetico> getFatores()
  {
    if (fatores == null)
    {
      fatores = new EObjectContainmentEList<FatorAritmetico>(FatorAritmetico.class, this, T5fPackage.TERMO_ARITMETICO__FATORES);
    }
    return fatores;
  }
  ...
  public EList<OutroFatorAritmetico> getOutros()
  {
    if (outros == null)
    {
      outros = new EObjectContainmentEList<OutroFatorAritmetico>(OutroFatorAritmetico.class, this, T5fPackage.TERMO_ARITMETICO__OUTROS);
    }
    return outros;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case T5fPackage.TERMO_ARITMETICO__FATORES:
        return ((InternalEList<?>)getFatores()).basicRemove(otherEnd, msgs);
      case T5fPackage.TERMO_ARITMETICO__OUTROS:
