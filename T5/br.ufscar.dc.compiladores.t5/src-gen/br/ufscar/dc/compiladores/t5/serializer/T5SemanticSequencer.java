...
import br.ufscar.dc.compiladores.t5.t5.ComandoCondicao;
import br.ufscar.dc.compiladores.t5.t5.ComandoEntrada;
import br.ufscar.dc.compiladores.t5.t5.ComandoRepeticao;
import br.ufscar.dc.compiladores.t5.t5.ComandoSaida;
...
import br.ufscar.dc.compiladores.t5.t5.FatorSubExpressao;
...
import br.ufscar.dc.compiladores.t5.t5.SubAlgoritmo;
import br.ufscar.dc.compiladores.t5.t5.T5Package;
import br.ufscar.dc.compiladores.t5.t5.TermoAritmetico;
import br.ufscar.dc.compiladores.t5.t5.TermoComparacaoRelacional;
import br.ufscar.dc.compiladores.t5.t5.TermoSubExpressaoRelacional;
...
public class T5SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_ComandoAtribuicao(ISerializationContext context, ComandoAtribuicao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.COMANDO_ATRIBUICAO__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.COMANDO_ATRIBUICAO__EXP));
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.COMANDO_ATRIBUICAO__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.COMANDO_ATRIBUICAO__VARIAVEL));
		}
		...
		feeder.accept(grammarAccess.getComandoAtribuicaoAccess().getVariavelDeclaracaoIDTerminalRuleCall_3_0_1(), semanticObject.eGet(T5Package.Literals.COMANDO_ATRIBUICAO__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_ComandoEntrada(ISerializationContext context, ComandoEntrada semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.COMANDO_ENTRADA__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.COMANDO_ENTRADA__VARIAVEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getComandoEntradaAccess().getVariavelDeclaracaoIDTerminalRuleCall_1_0_1(), semanticObject.eGet(T5Package.Literals.COMANDO_ENTRADA__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_ComandoRepeticao(ISerializationContext context, ComandoRepeticao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.COMANDO_REPETICAO__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.COMANDO_REPETICAO__EXP));
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.COMANDO_REPETICAO__CMD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.COMANDO_REPETICAO__CMD));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ComandoSaida(ISerializationContext context, ComandoSaida semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.COMANDO_SAIDA__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.COMANDO_SAIDA__VARIAVEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getComandoSaidaAccess().getVariavelDeclaracaoIDTerminalRuleCall_1_0_1(), semanticObject.eGet(T5Package.Literals.COMANDO_SAIDA__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_Declaracao(ISerializationContext context, Declaracao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.DECLARACAO__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.DECLARACAO__NAME));
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.DECLARACAO__TIPO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.DECLARACAO__TIPO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FatorNumero(ISerializationContext context, FatorNumero semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.FATOR_NUMERO__NUMERO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.FATOR_NUMERO__NUMERO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FatorSubExpressao(ISerializationContext context, FatorSubExpressao semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.FATOR_SUB_EXPRESSAO__EXPRESSAO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.FATOR_SUB_EXPRESSAO__EXPRESSAO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_FatorVariavel(ISerializationContext context, FatorVariavel semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.FATOR_VARIAVEL__VARIAVEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.FATOR_VARIAVEL__VARIAVEL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFatorVariavelAccess().getVariavelDeclaracaoIDTerminalRuleCall_0_1(), semanticObject.eGet(T5Package.Literals.FATOR_VARIAVEL__VARIAVEL, false));
		feeder.finish();
	}
	...
	protected void sequence_OutroFatorAritmetico(ISerializationContext context, OutroFatorAritmetico semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.OUTRO_FATOR_ARITMETICO__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.OUTRO_FATOR_ARITMETICO__OPERADOR));
	...
	protected void sequence_OutroTermoAritmetico(ISerializationContext context, OutroTermoAritmetico semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.OUTRO_TERMO_ARITMETICO__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.OUTRO_TERMO_ARITMETICO__OPERADOR));
	...
	protected void sequence_OutroTermoRelacional(ISerializationContext context, OutroTermoRelacional semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.OUTRO_TERMO_RELACIONAL__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.OUTRO_TERMO_RELACIONAL__OPERADOR));
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.OUTRO_TERMO_RELACIONAL__TERMO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.OUTRO_TERMO_RELACIONAL__TERMO));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_TermoComparacaoRelacional(ISerializationContext context, TermoComparacaoRelacional semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.TERMO_COMPARACAO_RELACIONAL__EXP1) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.TERMO_COMPARACAO_RELACIONAL__EXP1));
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.TERMO_COMPARACAO_RELACIONAL__OP_REL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.TERMO_COMPARACAO_RELACIONAL__OP_REL));
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.TERMO_COMPARACAO_RELACIONAL__EXP2) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.TERMO_COMPARACAO_RELACIONAL__EXP2));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_TermoSubExpressaoRelacional(ISerializationContext context, TermoSubExpressaoRelacional semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, T5Package.Literals.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, T5Package.Literals.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
