 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.ComandoSaidaImpl#getVariavel <em>Variavel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComandoSaidaImpl extends ComandoImpl implements ComandoSaida
{
  ...
  {
    return T5Package.Literals.COMANDO_SAIDA;
  }
    ...
    if (variavel != null && variavel.eIsProxy())
    {
      ...
      if (variavel != oldVariavel)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, T5Package.COMANDO_SAIDA__VARIAVEL, oldVariavel, variavel));
      }
    }
    return variavel;
  }
  ...
  public void setVariavel(Declaracao newVariavel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.COMANDO_SAIDA__VARIAVEL, oldVariavel, variavel));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case T5Package.COMANDO_SAIDA__VARIAVEL:
