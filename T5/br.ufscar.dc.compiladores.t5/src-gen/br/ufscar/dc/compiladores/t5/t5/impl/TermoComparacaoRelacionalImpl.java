 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.TermoComparacaoRelacionalImpl#getExp1 <em>Exp1</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.TermoComparacaoRelacionalImpl#getOpRel <em>Op Rel</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.TermoComparacaoRelacionalImpl#getExp2 <em>Exp2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TermoComparacaoRelacionalImpl extends TermoRelacionalImpl implements TermoComparacaoRelacional
{
  ...
  {
    return T5Package.Literals.TERMO_COMPARACAO_RELACIONAL;
  }
  ...
  public NotificationChain basicSetExp1(ExpressaoAritmetica newExp1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, T5Package.TERMO_COMPARACAO_RELACIONAL__EXP1, oldExp1, newExp1);
  ...
  public void setExp1(ExpressaoAritmetica newExp1)
  {
    if (newExp1 != exp1)
    {
      ...
      if (exp1 != null)
        msgs = ((InternalEObject)exp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_COMPARACAO_RELACIONAL__EXP1, null, msgs);
      if (newExp1 != null)
        msgs = ((InternalEObject)newExp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_COMPARACAO_RELACIONAL__EXP1, null, msgs);
      msgs = basicSetExp1(newExp1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TERMO_COMPARACAO_RELACIONAL__EXP1, newExp1, newExp1));
  }
  ...
  public void setOpRel(String newOpRel)
  {
    ...
    opRel = newOpRel;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TERMO_COMPARACAO_RELACIONAL__OP_REL, oldOpRel, opRel));
  }
  ...
  public NotificationChain basicSetExp2(ExpressaoAritmetica newExp2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, T5Package.TERMO_COMPARACAO_RELACIONAL__EXP2, oldExp2, newExp2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExp2(ExpressaoAritmetica newExp2)
  {
    if (newExp2 != exp2)
    {
      NotificationChain msgs = null;
      if (exp2 != null)
        msgs = ((InternalEObject)exp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_COMPARACAO_RELACIONAL__EXP2, null, msgs);
      if (newExp2 != null)
        msgs = ((InternalEObject)newExp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_COMPARACAO_RELACIONAL__EXP2, null, msgs);
      msgs = basicSetExp2(newExp2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TERMO_COMPARACAO_RELACIONAL__EXP2, newExp2, newExp2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case T5Package.TERMO_COMPARACAO_RELACIONAL__EXP1:
        return basicSetExp1(null, msgs);
      case T5Package.TERMO_COMPARACAO_RELACIONAL__EXP2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case T5Package.TERMO_COMPARACAO_RELACIONAL__EXP1:
        return getExp1();
      case T5Package.TERMO_COMPARACAO_RELACIONAL__OP_REL:
        return getOpRel();
      case T5Package.TERMO_COMPARACAO_RELACIONAL__EXP2:
        return getExp2();
    }
