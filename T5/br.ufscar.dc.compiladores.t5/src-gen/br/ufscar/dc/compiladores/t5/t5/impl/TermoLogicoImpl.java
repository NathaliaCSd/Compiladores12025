...
public class TermoLogicoImpl extends MinimalEObjectImpl.Container implements TermoLogico
{
  ...
  public NotificationChain basicSetRel(ExpressaoRelacional newRel, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, T5Package.TERMO_LOGICO__REL, oldRel, newRel);
  ...
  public void setRel(ExpressaoRelacional newRel)
  {
    if (newRel != rel)
    {
      ...
      if (rel != null)
        msgs = ((InternalEObject)rel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_LOGICO__REL, null, msgs);
      if (newRel != null)
        msgs = ((InternalEObject)newRel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_LOGICO__REL, null, msgs);
      msgs = basicSetRel(newRel, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TERMO_LOGICO__REL, newRel, newRel));
  }
