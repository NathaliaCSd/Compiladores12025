 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.TermoSubExpressaoRelacionalImpl#getExpRel <em>Exp Rel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TermoSubExpressaoRelacionalImpl extends TermoRelacionalImpl implements TermoSubExpressaoRelacional
{
  ...
  {
    return T5Package.Literals.TERMO_SUB_EXPRESSAO_RELACIONAL;
  }
  ...
  public NotificationChain basicSetExpRel(ExpressaoRelacional newExpRel, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, T5Package.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, oldExpRel, newExpRel);
  ...
  public void setExpRel(ExpressaoRelacional newExpRel)
  {
    if (newExpRel != expRel)
    {
      ...
      if (expRel != null)
        msgs = ((InternalEObject)expRel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, null, msgs);
      if (newExpRel != null)
        msgs = ((InternalEObject)newExpRel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - T5Package.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, null, msgs);
      msgs = basicSetExpRel(newExpRel, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, newExpRel, newExpRel));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case T5Package.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL:
