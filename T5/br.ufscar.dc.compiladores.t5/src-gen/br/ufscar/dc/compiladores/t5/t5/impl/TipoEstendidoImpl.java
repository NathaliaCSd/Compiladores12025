 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.TipoEstendidoImpl#getBasic <em>Basic</em>}</li>
 *   <li>{@link br.ufscar.dc.compiladores.t5.t5.impl.TipoEstendidoImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TipoEstendidoImpl extends MinimalEObjectImpl.Container implements TipoEstendido
{
  ...
  {
    return T5Package.Literals.TIPO_ESTENDIDO;
  }
  ...
  public void setBasic(String newBasic)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TIPO_ESTENDIDO__BASIC, oldBasic, basic));
  }
  ...
  public Declaracao getRef()
  {
    if (ref != null && ref.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, T5Package.TIPO_ESTENDIDO__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(Declaracao newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, T5Package.TIPO_ESTENDIDO__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case T5Package.TIPO_ESTENDIDO__BASIC:
        return getBasic();
      case T5Package.TIPO_ESTENDIDO__REF:
