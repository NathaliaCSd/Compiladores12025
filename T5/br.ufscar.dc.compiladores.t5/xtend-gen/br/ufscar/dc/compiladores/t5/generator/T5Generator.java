...
public class T5Generator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nThe method compilePrograma(Programa) from the type T5Generator refers to the missing type Programa");
  }

  public CharSequence compilePrograma(final /* Programa */Object p) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method getTipo(Declaracao) from the type T5Generator refers to the missing type Declaracao"
