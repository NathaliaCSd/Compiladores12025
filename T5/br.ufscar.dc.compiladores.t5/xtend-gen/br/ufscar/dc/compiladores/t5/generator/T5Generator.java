...
public class T5Generator extends AbstractGenerator {
  ...
  protected CharSequence _compileDeclaracao(final DeclaracaoGlobal d) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _compileCorpo = this.compileCorpo(d.getCorpo());
    _builder.append(_compileCorpo, "\t");
    _builder.newLineIfNotEmpty();
    _builder.append("}");
    _builder.newLine();
  ...
  public CharSequence compileCorpo(final Corpo c) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      for(final DeclaracaoLocal local : _locais) {
        Object _compileDeclaracao = this.compileDeclaracao(local);
        _builder.append(_compileDeclaracao);
        _builder.newLineIfNotEmpty();
      }
    }
    {
      ...
      for(final Comando cmd : _comandos) {
        CharSequence _compileComando = this.compileComando(cmd);
  ...
  protected CharSequence _compileComando(final ComandoLeia c) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      for(final Variavel alvo : _alvo) {
        ...
        _builder.append(_name);
        _builder.append(" = ");
        String _tipoLeitura = this.getTipoLeitura(((Variavel) alvo));
  ...
  public String compileFatorAritmetico(final FatorAritmetico f) {
    ...
    boolean _eIsSet = f.eIsSet(T5Package.Literals.FATOR_ARITMETICO__REAL);
    if (_eIsSet) {
      return f.getReal().toString();
    }
    boolean _eIsSet_1 = f.eIsSet(T5Package.Literals.FATOR_ARITMETICO__NUMERO);
    if (_eIsSet_1) {
