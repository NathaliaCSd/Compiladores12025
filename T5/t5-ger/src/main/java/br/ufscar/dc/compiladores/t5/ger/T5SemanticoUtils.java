...
class InfoIdentificador {
    public TipoT5 tipo; public boolean ehPonteiro; public boolean ehVetor; public TabelaDeSimbolos tabelaDoRegistro;
...
public class T5SemanticoUtils {
    ...
    public static TipoT5 getTipo(String tipoStr) {
        ...
        switch(tipoStr){
            case "literal": return TipoT5.LITERAL;
            case "inteiro": return TipoT5.INTEIRO;
            case "real": return TipoT5.REAL;
            case "logico": return TipoT5.LOGICO;
            default: return TipoT5.INVALIDO;
        }
    }
    public static boolean ehTipoNumeral(TipoT5 t1, TipoT5 t2){ return (t1 == TipoT5.INTEIRO && t2 == TipoT5.REAL) || (t1 == TipoT5.REAL && t2 == TipoT5.INTEIRO); }
    public static boolean ehTipoInteiroEmReal(TipoT5 t1, TipoT5 t2){ return t1 == TipoT5.REAL && t2 == TipoT5.INTEIRO; }
    ...
    public static InfoIdentificador verificarIdentificador(Escopos pilhaDeTabelas, T5Parser.IdentificadorContext ctx) {
        ...
        if (acessoVetor) {
            ...
            for (var exp : ctx.dimensao().exp_aritmetica()) {
                if (verificarTipo(pilhaDeTabelas, exp) != TipoT5.INTEIRO) adicionarErroSemantico(exp.start, "indice de vetor deve ser inteiro");
            }
        }
    ...
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.ExpressaoContext ctx) {
        ...
        for(int i = 1; i < ctx.termo_logico().size(); i++) {
            ...
            if(tipoResultante != TipoT5.LOGICO || proximoTipo != TipoT5.LOGICO) return TipoT5.INVALIDO;
        }
    ...
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.Fator_logicoContext ctx) { return verificarTipo(pilhaDeTabelas, ctx.parcela_logica()); }
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.Parcela_logicaContext ctx) { if(ctx.pl1 != null) return TipoT5.LOGICO; return verificarTipo(pilhaDeTabelas, ctx.pl2); }
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.Exp_relacionalContext ctx) {
        ...
        if (tipo1 == TipoT5.INVALIDO || tipo2 == TipoT5.INVALIDO) return TipoT5.INVALIDO;
        if (ehTipoNumeral(tipo1, tipo2) || (tipo1 == tipo2)) return TipoT5.LOGICO;
    ...
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.Exp_aritmeticaContext ctx) {
        ...
        for (int i = 1; i < ctx.termo().size(); i++) {
            ...
            if (proximoTipo == TipoT5.INVALIDO) return TipoT5.INVALIDO;
            if (ehTipoNumeral(tipoResultante, proximoTipo)) tipoResultante = TipoT5.REAL;
            else if (tipoResultante == TipoT5.LITERAL && proximoTipo == TipoT5.LITERAL) tipoResultante = TipoT5.LITERAL;
            else if (tipoResultante != proximoTipo) return TipoT5.INVALIDO;
        }
        return tipoResultante;
    }
    ...
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.FatorContext ctx) { return verificarTipo(pilhaDeTabelas, ctx.parcela(0)); }
    ...
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.Parcela_nao_unarioContext ctx) {
        if (ctx.pn1 != null) {
            if (ctx.getText().startsWith("&")) return TipoT5.ENDERECO;
            return verificarIdentificador(pilhaDeTabelas, ctx.pn1).tipo;
        } else { return TipoT5.LITERAL; }
    }
    public static TipoT5 verificarTipo(Escopos pilhaDeTabelas, T5Parser.Parcela_unarioContext ctx) {
        ...
        if (ctx.p3 != null) return TipoT5.INTEIRO;
        if (ctx.p4 != null) return TipoT5.REAL;
    ...
    public static void verificarParametros(Escopos pilhaDeTabelas, EntradaTabelaDeSimbolos subRotina, List<T5Parser.ExpressaoContext> args, Token tokenChamada) {
